...
synthesizer_agent_query_search = LlmAgent(
    name="SynthesizerAgent_query_search",
    model=GEMINI_MODEL,
    description="Synthesizes user question, database query result, and googles earch result into a comprehensive report",
