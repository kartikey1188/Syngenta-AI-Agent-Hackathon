...
rag_agent_3 = Agent(
   ...
   IF YOU ENCOUNTER A QUERY THAT REQUIRES BOTH RAG AND DATABASE SEARCH, ONLY FOCUS ON RAG OPERATIONS. DON'T GET DISTRACTED BY DATABASE QUERIES AND DON'T BE DISCOURAGED.
    """,
